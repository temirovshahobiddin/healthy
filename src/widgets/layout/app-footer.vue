...
<template>
  <app-section-fluid class="!bg-[#6f8f6e] py-[10px]">
    <div class="flex items-center justify-between">
      ...
      <div class="relative flex items-center gap-[20px] md:w-[160px]">
        ...
        ></a>
        <a
          class="h-[30px] w-[30px] shrink-0 cursor-pointer overflow-hidden bg-[url(https://codia-f2c.s3.us-west-1.amazonaws.com/image/2025-07-20/M0xHPN9iJa.png)] bg-cover bg-no-repeat md:h-[40px] md:w-[40px]"
          target="_blank"
  ...
  <app-section-fluid class="border-t border-t-[#ffffff20] !bg-[#6f8f6e]">
    <div
      class="mx-auto grid grid-cols-4 items-center justify-between gap-[40px] py-[30px] md:py-[60px] max-[1100px]:grid-cols-3 max-[768px]:grid-cols-2 max-[630px]:grid-cols-1"
    >
      ...
      <div class="flex flex-col flex-nowrap items-start gap-[10px] md:gap-[15px] max-w-[224px] max-[1100px]:max-w-[unset]">
        <span class="relative font-['Onest'] text-mobile-body-16 font-normal text-[#fff] md:text-[20px] leading-[1.2] md:font-medium">
