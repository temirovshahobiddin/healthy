...
const formatTime = (time: string) => {
  if (!time) return ''
  // Split "14:31:05" → take only hours and minutes
  ...
  <div
    ...
    <div class="flex-1">
      <ul class="grid grid-cols-2 border-y border-[#E0E5E3] max-[501px]:grid-cols-1 max-[501px]:border-y-0">
        <li
          ...
          <div
            ...
            <svg class="h-full w-full" width="45" height="45" viewBox="0 0 45 45" fill="none"
              ...
              <path
                ...
                stroke="#63845C" stroke-width="2.5" />
            </svg>
          </div>
        ...
        <li
          ...
          <div>
            ...
            <a :href="`tel:${siteSettings?.phone?.trim()}`" class="block text-[clamp(1rem,0.885rem+0.51vw,1.5rem)] font-semibold leading-[1.2] text-black/100">
        ...
        <li
          ...
          <div
            ...
            <svg class="h-full w-full" width="45" height="45" viewBox="0 0 45 45" fill="none"
              ...
              <path
                ...
                stroke="#63845C" stroke-width="2.5" />
              <path d="M22.5 13.125V22.5L27.75 27.75" stroke="#63845C" stroke-width="2.5" stroke-linecap="round"
          ...
          <div>
            ...
            <p class="text-[clamp(1rem,0.885rem+0.51vw,1.5rem)] font-semibold leading-[1.2] text-black/100">
              {{ formatTime(siteSettings.start_time) }} – {{ formatTime(siteSettings.end_time) }}
            </p>
          </div>
        </li>
          ...
          <div
            ...
            <svg class="h-full w-full" width="45" height="45" viewBox="0 0 45 45" fill="none"
              ...
              <path
                ...
                stroke="#63845C" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
          </div>
      ...
      <div class="flex gap-[clamp(0.625rem,0.481rem+0.64vw,1.25rem)] max-[501px]:flex-col">
        ...
        <UiButton class="max-w-[223px] flex-1 !bg-[#63845C33]/20 !text-green-500 max-[501px]:max-w-[unset]"
          @click="openModal">
          Поделиться
        </UiButton>
      </div>
    ...
    <div
      ...
      <iframe class="h-full w-full max-[1301px]:h-[228px]"
        ...
        width="670" height="614" frameborder="0" />
    </div>
  </div>
  <!-- :src="siteSettings.address_url" -->

  <UiModal id="share-modal" label="Поделиться контактами"
