...
const allServices = ref([
  ...
  "Сеанс гипнотерапии (гипноз)",
  "Сеанс комплексной психотерапии",
  "Сеанс гипнотерапии (гипноз)",
  "Сеанс психолога",
  "Сеанс психиатра",
  "Сеанс медицинского психолога"
])
      ...
      <div class="modal-content relative w-full rounded-t-[20px] bg-white px-4 pt-8 sm:w-fit sm:rounded-[20px] sm:p-6">
        ...
        >
          ...
          <div class="relative w-full overflow-hidden rounded-xl bg-[#F8F8F8] px-4 py-2.5">
            ...
            <!-- progress -->
            <div
              class="absolute bottom-0 left-0 h-[2px] w-full bg-green-500 transition-all duration-300"
          ...
          <template v-if="currentStep === 1">
            ...
            <CustomSelect
              ...
              :placeholder="t('order_modal.search_service')"
              :options="allServices"
              :random-suggestions-count="4"
            />
          </template>
          ...
          <template v-else-if="currentStep === 2">
            ...
            <CustomSelect
              v-model="formState.specialist"
              :placeholder="t('order_modal.search_specialist')"
